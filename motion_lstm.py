...
class ImprovedLSTMPredictor(nn.Module):
    """
    Decoder-style LSTM: run source sequence, then predict target steps autoregressively.
    input_dim=13 (motion features + score), output_dim=5 (delta xywh + confidence).
    """
